...
#define STRING_CONFIG_H_AUTHOR "(Chimera, single Extruder Config)" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 700, 700, 500, 200 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 750, 500 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 7000, 7000, 300, 8000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -60, 0, -2.2 }
 ...
 * readings with inductive probes and piezo sensorsng
 * .
 o*/
 ...
 */
#define FILAMENT_RUNOUT_SENSOR  // default pin skr 1.3 x+ endstop :
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 35.0 // (mm) Default fade height.
  #endif
...
#define PREHEAT_3_TEMP_CHAMBER 85
