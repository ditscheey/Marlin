...
//#define LASER_FEATURE
  ...
  #define SPINDLE_LASER_ENA_PIN         P1_28 // using endstop X-max as spindle enable
  #define SPINDLE_LASER_PWM_PIN         P1_27 // using endstop Z-max as spindle pwm control
...
//#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "!!TODO Set Coordinate System"
  #define MAIN_MENU_ITEM_1_GCODE "M503"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Reset All Coordinates"
  #define MAIN_MENU_ITEM_2_GCODE "G92 X0 Y0 Z0"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_3_DESC "Home Z Axis"
  #define MAIN_MENU_ITEM_3_GCODE "G28 Z"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Home XY"
