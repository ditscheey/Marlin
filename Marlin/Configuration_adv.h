...
//#define LASER_FEATURE
  ...
  #define SPINDLE_LASER_ENA_PIN         P1_28       // 
  #define SPINDLE_LASER_PWM_PIN         P1_24       // 
  ...
  #define AIR_EVACUATION                     // Cutter Vacuum / Laser Blower motor control with G-codes M10-M11
   ...
   #define AIR_EVACUATION_PIN           P1_26     // Override the default Cutter Vacuum or Laser Blower pin
  #endif

  //#define AIR_ASSIST                         // Air Assist control with G-codes M8-M9
  #if ENABLED(AIR_ASSIST)
    #define AIR_ASSIST_ACTIVE           LOW    // Active state on air assist pin
    #define AIR_ASSIST_PIN              P0_23     // Override the default Air Assist pin
  #endif
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
     ...
     */
    #if ENABLED(SPINDLE_LASER_USE_PWM)
      #define SPEED_POWER_INTERCEPT      25     // (%) 0-100 i.e., Minimum power percentage
    ...
    #if ENABLED(SPINDLE_LASER_USE_PWM)
      #define SPEED_POWER_INTERCEPT      25    // (%) 0-100 i.e., Minimum power percentage
      #define SPEED_POWER_MIN            25    // (%) 0-100
      #define SPEED_POWER_MAX           100    // (%) 0-100
      #define SPEED_POWER_STARTUP        25    // (%) M3/M4 speed/power default (with no arguments)
    #endif
...
#define COOLANT_CONTROL
 ...
 // #define COOLANT_MIST                // Enable if mist coolant is present
  ...
  #define COOLANT_FLOOD_PIN    P1_24   // coolant flood pin 
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_3_DESC "Home XY"
